...
const CalendarView = () => {
 ...
 const fetchEvents = async (retryCount = 0) => {
  ...
  if (!selectedCalendarId) {
    ...
    setEvents([]); // Set to empty array if no calendar is selected
  ...
  try {
    ...
    const allEvents = fetchedEvents; // No dummy events
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <DialogTitle id="delete-event-dialog-title" sx={{ display: 'flex', alignItems: 'center', p: 2 }}>
            {/* match Lead/Activity style with warning icon */}
            <WarningIcon sx={{ mr: 1 }} />
          ...
          <DialogContent sx={{ p: 3 }}>
            <Typography variant="body1" mb={2}>
              To confirm the deletion of this event, please type the event title below.
            </Typography>
            ...
            <Box display="flex" alignItems="center" mb={2} justifyContent="flex-start">
              <IconButton
                size="small"
                onClick={() => navigator.clipboard.writeText(deleteDialog?.title || '')}
                sx={{ mr: 1 }}
              >
            ...
            <Button
              ...
              sx={{
                '&:hover': {
                  ...
                  bgcolor: (theme) => alpha(theme.palette.error.main, theme.palette.action.hoverOpacity)
                }
              }}
            >
              Delete
